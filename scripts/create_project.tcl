...
set files_vhd [list \
 [file normalize "${project_src}/WasmFpgaUart.vhd" ]\
 [file normalize "${project_src}/uart_tx6.vhd" ]\
 [file normalize "${project_src}/uart_rx6.vhd" ]\
...
set obj [get_filesets sources_1]
set_property -name "top" -value "WasmFpgaUart" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "${project_src}/WasmFpgaUart.vhd" -objects $obj
...
set files [list \
 "[file normalize "${project_ip}/UartRxFifo/UartRxFifo.xci"]"\
]
...
set files [list \
 ...
 "[file normalize "${project_tb}/tb_WasmFpgaUart.vhd"]"\
]
...
set obj [get_filesets sim_1]
set_property "top" "tb_WasmFpgaUart" $obj
